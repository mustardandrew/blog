    ...
    <div class="mx-auto max-w-7xl px-6 py-12 lg:px-8">
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-4">
            ...
            <div class="lg:col-span-1">
                ...
                <p class="text-sm text-zinc-600 dark:text-zinc-400">
                    A modern blog platform built with Laravel, Livewire, and Flux UI. Share your thoughts and connect with readers worldwide.
                </p>
                <div class="mt-6 flex space-x-4">
                    <!-- Social Media Links -->
                    <a href="https://x.com/intent/tweet?text=Check%20out%20this%20amazing%20blog%20platform%20built%20with%20Laravel%20and%20Livewire!&url={{ urlencode(request()->getSchemeAndHttpHost()) }}" target="_blank" rel="noopener noreferrer" class="text-zinc-400 hover:text-zinc-600 dark:hover:text-zinc-300 transition-colors">
                        <span class="sr-only">Share on X</span>
                        <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                        </svg>
                    </a>
                    <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(request()->getSchemeAndHttpHost()) }}&quote=Check%20out%20this%20modern%20blog%20platform%20built%20with%20Laravel%20and%20Livewire!" target="_blank" rel="noopener noreferrer" class="text-zinc-400 hover:text-zinc-600 dark:hover:text-zinc-300 transition-colors">
                        <span class="sr-only">Share on Facebook</span>
                        <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                        </svg>
                    </a>
                    <a href="https://www.linkedin.com/sharing/share-offsite/?url={{ urlencode(request()->getSchemeAndHttpHost()) }}&title=Modern%20Blog%20Platform&summary=Check%20out%20this%20modern%20blog%20platform%20built%20with%20Laravel,%20Livewire,%20and%20Flux%20UI" target="_blank" rel="noopener noreferrer" class="text-zinc-400 hover:text-zinc-600 dark:hover:text-zinc-300 transition-colors">
                    ...
                    <a href="https://api.whatsapp.com/send?text=Check%20out%20this%20amazing%20blog%20platform%20built%20with%20Laravel%20and%20Livewire!%20{{ urlencode(request()->getSchemeAndHttpHost()) }}" target="_blank" rel="noopener noreferrer" class="text-zinc-400 hover:text-zinc-600 dark:hover:text-zinc-300 transition-colors">
                    ...
                    <a href="https://t.me/share/url?url={{ urlencode(request()->getSchemeAndHttpHost()) }}&text=Check%20out%20this%20amazing%20blog%20platform%20built%20with%20Laravel%20and%20Livewire!" target="_blank" rel="noopener noreferrer" class="text-zinc-400 hover:text-zinc-600 dark:hover:text-zinc-300 transition-colors">
            ...
            <!-- Newsletter -->
            <div>
                <h3 class="text-sm font-semibold text-zinc-900 dark:text-zinc-100 mb-4">Stay Updated</h3>
        ...
        <div class="mt-12 pt-8 border-t border-zinc-200 dark:border-zinc-700">
            <div class="flex flex-col items-center justify-between gap-4 md:flex-row">
                <p class="text-sm text-zinc-600 dark:text-zinc-400">
                    © {{ date('Y') }} Blog Platform. Built with Laravel and Livewire.
                </p>
